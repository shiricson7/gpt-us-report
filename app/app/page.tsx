  ...
  return (
    <div className="grid gap-6">
      <div className="rounded-2xl border border-white/60 bg-white/70 p-6 shadow-sm backdrop-blur">
        <h2 className="text-lg font-semibold">Ultrasound Report with AI</h2>
        <p className="mt-1 text-sm text-slate-600">
          Create, refine, and print pediatric ultrasound reports.
        </p>
      ...
      <div className="rounded-2xl border border-white/60 bg-white/70 p-6 shadow-sm backdrop-blur">
        <h2 className="text-lg font-semibold">Thyroid Ultrasound Report with AI</h2>
        <p className="mt-1 text-sm text-slate-600">
